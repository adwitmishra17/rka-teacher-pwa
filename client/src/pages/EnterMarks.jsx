  ...
  return (
    <div style={{ padding:'20px' }}>
      <div className="fade-up" style={{ marginBottom:20 }}>
        ...
        <p style={{ fontSize:13, color:'var(--text-muted)', marginTop:3 }}>Monthly class tests · select a test and enter marks</p>
      </div>
      <div style={{ display: 'flex', gap: 8, alignItems: 'flex-start', background: 'var(--green-light)', border: '1px solid var(--green-muted)', borderRadius: 'var(--radius-md)', padding: '9px 12px', fontSize: 12, color: 'var(--green-dark)', lineHeight: 1.5, marginBottom: 14 }}>
          ...
          <span>These are the monthly tests, not exam papers. They do not appear on the report card (Classes 9–10 only: their average feeds the M.A. column). For PA-1, PA-2, Half-Yearly and Annual papers use <b>Enter Exam Marks</b>.</span>
        </div>
