...
// Syllabus PDFs live in the shared rka-academic-tracker Storage bucket (same
// project this backend already verifies tokens against). Overridable via env
// in case the default bucket name differs.
export const SYLLABUS_BUCKET = process.env.FIREBASE_STORAGE_BUCKET || 'rka-academic-tracker.firebasestorage.app'
export function getSyllabusBucket() { ensureInit(); return getStorage().bucket(SYLLABUS_BUCKET) }
